...
+ UI组件库：[Element](http://element.eleme.io/#/zh-CN/component/quickstart),[iview](https://github.com/iview/iview)
+ HTTP请求库：[axios](https://github.com/mzabriskie/axios)
+ CSS的预处理框架: [Stylus](http://stylus-lang.com/),[中文文档](http://www.zhangxinxu.com/jq/stylus/),[sass](http://sass.bootcss.com/),[less](http://lesscss.org/)
